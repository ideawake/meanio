...
var express = require('express'),
  ...
  IPWhitelistMW = require('../middlewares/ip-whitelist'),
  IpDeniedError = require('express-ipfilter').IpDeniedError; // required to be in parent
